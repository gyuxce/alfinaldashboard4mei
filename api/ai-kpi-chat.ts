...
function buildPrompt({
  ...
  return [
    ...
    'Saat memberi ringkasan performa atau coaching, wajib cek semua KPI utama: Productivity, CSAT Official, CSAT Takeout/SC, QA Score, QA Defect, SLA 1 menit, SLA 3 menit, WHU, Attendance/Schedule, RCA, trendSamples, dan ranking risiko.',
    'Jangan hanya fokus ke CSAT dan QA kecuali user memang meminta khusus CSAT/QA.',
    'Kamu bisa membaca semua area dashboard dari context: productivityTotal, productivityAverage, manDays, CSAT official, CSAT SC/takeout, badCsatDetails, QA, qaDefectDetails, highQaDetails, SLA, WHU, attendance/schedule, RCA, trendSamples, dan ranking risiko.',
